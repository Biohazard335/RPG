...
public class L4r_3 extends Lolcation {
	public L4r_3() {
		super(
				4,
				-3,
				0,
				"Blockade",
				"An Imperial Guard stands at the front of the blockade, the steep cliff protecting"+
				" from the East. He looks at you with suspicion.",
				new Object[] { "North", "West", "Talk", "Fight!" },
	...
	public void afterMath(int chosen) {
		this.description = "The blockade is empty in this area. There is a steep cliff to the East";
